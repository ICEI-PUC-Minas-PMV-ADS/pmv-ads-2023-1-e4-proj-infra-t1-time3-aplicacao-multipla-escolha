...
export default function EditarAtividadePage({ navigation, route }) {
  ...
  if (openModalQuestao) {
    return (
      <View style={styles.container}>
        <NavbarComponent title="Editar Atividade" />
        <ScrollView
          style={{
            margin: 60,
            display: 'flex',
  ...
  return (
    <View style={styles.container}>
      <NavbarComponent title="Editar Atividade" goBack={true} />
      <ScrollView style={{ margin: 30, display: 'flex', alignItems: 'center' }}>
        <View style={{ margin: 30, display: 'flex', alignItems: 'center' }}>
          ...
          <Button
            style={styles.ButtonCriarAtividade}
            mode="contained"
            onPress={() => handleEditarAtividade()}>
            <Text style={{ color: 'white' }}>Editar Atividade</Text>
          </Button>
          <Button
            style={styles.ButtonCancelar}
            mode="contained"
